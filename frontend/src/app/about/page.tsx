...
export const metadata = {
    title: "About - ContractRisk AI",
    description: "About the x402 Contract Risk Analyzer — a pay-per-use AI project built on Algorand and Groq.",
};
    ...
    return (
        <div className={styles.page}>
            <section className={styles.hero}>
                ...
                <h1 className={styles.heroTitle}>About ContractRisk AI</h1>
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.pricingCard}>
                        <div className={styles.pricingLeft}>
                            <div className={styles.pricingAmount}>$0.50</div>
