/**
 * Builds the LLM prompt for contract risk extraction.
 * Returns a strict JSON instruction so the model never produces prose.
 */
export function buildRiskExtractionPrompt(contractText: string): string {
